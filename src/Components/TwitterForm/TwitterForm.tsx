    ...
    return (
        <div className="border-b border-gray-700 w-full px-4">
            ...
            <div className="flex items-center justify-between py-2">
                <div className="flex flex-col gap-2  md:flex-row lg:flex-row w-full justify-between items-center">
                    ...
                    <button
                        ...
                        className="  w-full md:w-auto bg-blue-400 text-white rounded-full font-bold px-6 py-2 hover:bg-blue-600 traansition duration-200 cursor-pointer ">
                        Tweet
                    </button>
                </div>
            </div>
